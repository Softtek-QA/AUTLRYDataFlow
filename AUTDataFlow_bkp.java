 ...
 *
 */
public class AUTDataFlow_bkp extends AUTFWKTestObjectBase{
	...
	java.util.HashMap<Integer,java.util.HashMap<String,Object>>> autInitDataFlowConfiguration(boolean syncronizeAllObject) {
		try {
			...
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_TIPO_PESSOA", AUT_SAFE_TYPE_PERSONS.FISICA2 );
			...
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_DOCUMENTO", "84276517915");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_PF_RG", "84276517915");			
			...
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_CLIENTE_NOME", "José da Silva" );
			...
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_TEL_FONE1","19855555");
 			...
 			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_VALOR_VOUCHER", 1000 );
 			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_LOJA", AUT_SAFE_LOJAS_ENUM.LJ0019);
 			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_OBSERVACOES", "Criação de voucher Pessoa Física ----------------------------------------------------------.");
			...
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("USER_SAFE", "51032901");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("PWS_SAFE", "#u5051s7923");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_TIPO_PESSOA", AUT_SAFE_TYPE_PERSONS.JURIDICA2 );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_TIPO_CONVENIO", AUT_SAFE_TIPO_CONVENIO.ACORDO_EXTRAJUDICIAL );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_PROFISSAO", AUT_SAFE_PROFISSOES.DECORADOR );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_DOCUMENTO", AUTProjectsFunctions.gerarCNPJ());
			...
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_CEP","75001");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_CIDADE","Paris");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_UF", "SP");
			...
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_TEL_RAMAL1","");
 			...
 			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_VALOR_VOUCHER", 10000 );
 			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_LOJA", AUT_SAFE_LOJAS_ENUM.LJ0019);
 			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_OBSERVACOES", "Criação de voucher Pessoa Jurídica ----------------------------------------------------------.");
