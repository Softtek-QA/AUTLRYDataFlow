...
public class AUTDataFlow extends AUTFWKTestObjectBase{
	...
	java.util.HashMap<Integer,java.util.HashMap<String,Object>>> autInitDataFlowConfiguration(boolean syncronizeAllObject) {
		try {
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00003_CTP00001.get(1).put("AUT_FANTASIA", AUT_VA_CADASTROS.JURIDICA_ATUALIZACAO);
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_USER","55708317");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_PASSWORD", "1234");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_CODIGO_ITEM","89407066");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_NUMERO_DOCUMENTO", "94288636370");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_LOJA_SELECIONADA",AUTSelecaoLojaBoitata.AUT_BOITATA_LISTA_LOJAS.LM_0035_CURITIBA.toString());
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_FLUXO_SAIDA", AUTFluxoSaida.AUT_VA_FLUXO_SAIDA.RETIRA_INTERNA_IMEDIATA);
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_NUMERO_PEDIDO", "");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_TIPO_CADASTRO", AUT_VA_CADASTROS.JURIDICA);
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_PASSAPORTE", codEstrangeiro);
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_CNPJ", cnpj);
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_CPF", cpf);
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_INCRICAO_ESTADUAL", inscricaoEstadual);
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_INCRICAO_ESTADUAL_PF", inscricaoEstadual);	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_INCRICAO_MUNICIPAL", inscricaoEstadual);	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_NOME_PJ_CONTATO", "NOME CONTATO PJ");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_PJ_EMAIL_CONTATO", "EMAIL.QA@TESTE.COM.BR");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_PJ_DEPARTAMENTO_CONTATO", "QUALIDADE");	
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_UF_PESQUISA", AUT_VA_ESTADOS.PR);	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_CIDADE_PESQUISA", "BOCAIÚVA");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_ENDERECO_PESQUISA", "RUA CIDADE JARDIM");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_BAIRRO_PESQUISA", "Alto");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_TIPO_ENDERECO", AUT_VA_TIPO_ENDERECO.OBRA);
			
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_CEP", "82590-100");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_RUA_ENDERECO", "BR116");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_NUMERO_ENDERECO", "256");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_BAIRRO_ENDERECO", "Alto");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_COMPLEMENTO_ENDERECO", "CASA 123");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_CIDADE_ENDERECO", "Curitiba");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_ESTADO_ENDERECO", AUT_VA_ESTADOS.PR);	
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_CEP_2", "82590-100");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_RUA_ENDERECO_2", "BR116");	
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00005_CTP00001.get(1).put("AUT_ESTADO_ENDERECO_2", AUT_VA_ESTADOS.PR);	
