...
public class AUTDataFlow {
	...
	java.util.HashMap<Integer,java.util.HashMap<String,Object>>> autInitDataFlow() {
		try {
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00004_CN00002_CTP00001.get(1).put("AUT_USER", "5576316456068");
			vaDataRSP_PJTTRC_FRT001_VA_MD00004_CN00002_CTP00001.get(1).put("AUT_PASSWORD", "1234");
			vaDataRSP_PJTTRC_FRT001_VA_MD00004_CN00002_CTP00001.get(1).put("AUT_QUANTIDADE_ITEM", "1");
			vaDataRSP_PJTTRC_FRT001_VA_MD00004_CN00002_CTP00001.get(1).put("AUT_CODIGO_ITEM", "89296193");
			vaDataRSP_PJTTRC_FRT001_VA_MD00004_CN00002_CTP00001.get(1).put("AUT_NUMERO_DOCUMENTO", "43409000283");
