...
public class AUTDataFlow extends AUTFWKTestObjectBase{
	...
	java.util.HashMap<Integer,java.util.HashMap<String,Object>>> autInitDataFlowConfiguration(boolean syncronizeAllObject) {
		try {
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00009_CN00001_CTP00001.get(1).put("USER_SAP", "51013346");
			vaDataRSP_PJTTRC_FRT001_VA_MD00009_CN00001_CTP00001.get(1).put("PWD_SAP", "QWEasd@1234");
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00009_CN00002_CTP00001.get(1).put("AUT_USER", "55000045");//55000045
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00009_CN00003_CTP00001.get(1).put("AUT_OPERADOR", "951028487");
			vaDataRSP_PJTTRC_FRT001_VA_MD00009_CN00003_CTP00001.get(1).put("AUT_PWD_OPERADOR", "951028487");
			vaDataRSP_PJTTRC_FRT001_VA_MD00009_CN00003_CTP00001.get(1).put("AUT_COORDENADOR", "9951028487");
			vaDataRSP_PJTTRC_FRT001_VA_MD00009_CN00003_CTP00001.get(1).put("AUT_FLUXO_SAIDA",   br.lry.components.va.AUTVAGeradorPedido.AUT_VA_FLUXO_SAIDA.REITRADA_EXTERNA_IMEDIATA.name());
