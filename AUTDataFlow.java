...
public class AUTDataFlow extends AUTFWKTestObjectBase{
	...
	java.util.HashMap<Integer,java.util.HashMap<String,Object>>> autInitDataFlowConfiguration(boolean syncronizeAllObject) {
		try {
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_CODIGO_ITEM","89455163");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_CODIGO_ITEM_VA","89296193");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_NUMERO_DOCUMENTO", "18.783.107/6918-63");  //  4294271183
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_LOJA_SELECIONADA",AUTSelecaoLojaBoitata.AUT_BOITATA_LISTA_LOJAS.LM_0045_SAO_BERNARDO_DO_CAMPO.toString());
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_FLUXO_SAIDA", AUTFluxoSaida.AUT_VA_FLUXO_SAIDA.CAIXA);
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_SEXO", "Feminino");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_NASCIMENTO", "04/03/1990");
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_TIPO_TELEFONE", AUT_VA_TIPO_CONTATO.CELULAR );	//Correção
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_CIDADE_PESQUISA", "CAJAMAR");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_ENDERECO_PESQUISA", "RUA PREFEITO ANTONIO GARRIDO");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_BAIRRO_PESQUISA", "JORDANÃ‰SIA");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_TIPO_ENDERECO", AUT_VA_TIPO_ENDERECO.OBRA);

			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_CEP", "07776-000");	
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_BAIRRO_ENDERECO", "EXPLANADA");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_COMPLEMENTO_ENDERECO", "CASA 123");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_CIDADE_ENDERECO", "BOCAIÃšVA");	
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_CEP_2", "06013-006");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_RUA_ENDERECO_2", "Rua AntÃ´nio AgÃº");	
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00004_CTP00001.get(1).put("AUT_ESTADO_ENDERECO_2", AUT_VA_ESTADOS.SP);	
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_USER","55708317");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_PASSWORD", "1234");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_CODIGO_ITEM","89407066");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_NUMERO_DOCUMENTO", "94288636370");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_LOJA_SELECIONADA",AUTSelecaoLojaBoitata.AUT_BOITATA_LISTA_LOJAS.LM_0035_CURITIBA.toString());
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_FLUXO_SAIDA", AUTFluxoSaida.AUT_VA_FLUXO_SAIDA.RETIRA_INTERNA_IMEDIATA);
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_NUMERO_PEDIDO", "");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_TIPO_CADASTRO", AUT_VA_CADASTROS.JURIDICA);
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_PASSAPORTE", codEstrangeiro);
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_CNPJ", cnpj);
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_CPF", cpf);
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_CPF_ESTRANGEIRO", cpfEstrangeiro);
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_NOME_ESTRANGEIRO", String.format("AUT NOME ESTRANG: %s : CPF EST: %s",codEstrangeiro,cpfEstrangeiro));	
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_NOME_PJ_FANTASIA", "AUT NOME PJ:".concat(AUTProjectsFunctions.gerarEstrangeiro()));	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_NOME_PJ_FANTASIA2", "AUT NOME PJ 2:".concat(AUTProjectsFunctions.gerarEstrangeiro()));	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_EMAIL", "aut.qaemail@automation.com");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_INCRICAO_ESTADUAL", inscricaoEstadual);
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_INCRICAO_ESTADUAL_PF", inscricaoEstadual);	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_INCRICAO_MUNICIPAL", inscricaoEstadual);	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_NOME_PJ_CONTATO", "NOME CONTATO PJ");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_PJ_EMAIL_CONTATO", "EMAIL.QA@TESTE.COM.BR");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_PJ_DEPARTAMENTO_CONTATO", "QUALIDADE");	
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_NUMERO_TELEFONE2", "115188-3067");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_UF_PESQUISA", AUT_VA_ESTADOS.PR);	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_CIDADE_PESQUISA", "BOCAIÚVA");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_ENDERECO_PESQUISA", "RUA CIDADE JARDIM");
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_BAIRRO_PESQUISA", "Alto");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_TIPO_ENDERECO", AUT_VA_TIPO_ENDERECO.OBRA);
			                                            
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_CEP", "82590-100");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_RUA_ENDERECO", "BR116");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_NUMERO_ENDERECO", "256");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_BAIRRO_ENDERECO", "Alto");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_COMPLEMENTO_ENDERECO", "CASA 123");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_CIDADE_ENDERECO", "Curitiba");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_ESTADO_ENDERECO", AUT_VA_ESTADOS.PR);	
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_CEP_2", "82590-100");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_RUA_ENDERECO_2", "BR116");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_NUMERO_ENDERECO_2", "256");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_BAIRRO_ENDERECO_2", "Centro");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_COMPLEMENTO_ENDERECO_2", "CASA 123");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_CIDADE_ENDERECO_2", "Osasco");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_ESTADO_ENDERECO_2", AUT_VA_ESTADOS.PR);	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_REFERENCIA_ENDERECO_2", "Loja Sabaroa");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_TIPO_IMOVEL_RESIDENCIA_2", AUT_VA_TIPO_RESIDENCIA.LOJA_OU_SOBRELOJA);	
                                                        
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_CNPJ_INVALIDO", "37.764.388/0009-90");	
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_CPF_INVALIDO", "510.354.523-93");	
                                                     
			vaDataRSP_PJTTRC_FRT001_VA_MD00000_CN00006_CTP00001.get(1).put("AUT_CEP_INVALIDO", "12345678");
