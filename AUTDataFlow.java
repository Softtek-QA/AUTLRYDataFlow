...
public class AUTDataFlow extends AUTFWKTestObjectBase{
	...
	public enum AUT_TABLE_PARAMETERS_NAMES{
		...
		RSP_PJTTRC_FRT001_SAFE_MD00012_CN00009_CTP00001,			
		RSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001,			
		RSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001,			
		RSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001,			
	...
	java.util.HashMap<Integer,java.util.HashMap<String,Object>>> autInitDataFlowConfiguration(boolean syncronizeAllObject) {
		try {
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00012_CN00001_CTP00001.get(1).put("AUT_NUMERO_DOCUMENTO", "94288636370"); 
			...
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00001_CTP00003.get(1).put("AUT_COORDENADOR", "51013346");				
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00001_CTP00003.get(1).put("AUT_PWD_COORDENADOR", "51013346");			
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00012_CN00001_CTP00004.get(1).put("AUT_NUMERO_DOCUMENTO", "94288636370"); 
			...
			sapDataRSP_PJTTRC_FRT001_SAP_MD00012_CN00001_CTP00005.get(1).put("AUT_DATA_INICIAL", "01.07.2019");	
			sapDataRSP_PJTTRC_FRT001_SAP_MD00012_CN00001_CTP00005.get(1).put("AUT_DATA_FINAL", "30.07.2019");			
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00012_CN00001_CTP00006.get(1).put("AUT_NUMERO_DOCUMENTO", "94288636370"); 
			...
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00001_CTP00007.get(1).put("AUT_COORDENADOR", "51013346");	
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00001_CTP00007.get(1).put("AUT_PWD_COORDENADOR", "51013346");	
			...
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00001_CTP00007.get(1).put("AUT_NUMERO_DOCUMENTO", "94288636370"); 	
			...
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00001_CTP00009.get(1).put("USER_SAFE", "51032900");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00001_CTP00009.get(1).put("PWS_SAFE", "Softtek01");
			...
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00002_CTP00003.get(1).put("AUT_COORDENADOR", "51013346");				
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00002_CTP00003.get(1).put("AUT_PWD_COORDENADOR", "51013346");			
			...
			sapDataRSP_PJTTRC_FRT001_SAP_MD00012_CN00002_CTP00005.get(1).put("AUT_DATA_INICIAL", "01.07.2019");	
			sapDataRSP_PJTTRC_FRT001_SAP_MD00012_CN00002_CTP00005.get(1).put("AUT_DATA_FINAL", "30.07.2019");			
			...
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00002_CTP00007.get(1).put("AUT_COORDENADOR", "51013346");	
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00002_CTP00007.get(1).put("AUT_PWD_COORDENADOR", "51013346");			
			...
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00002_CTP00007.get(1).put("AUT_NUMERO_DOCUMENTO", "FR1234"); 			
			...
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00002_CTP00009.get(1).put("USER_SAFE", "51032900");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00002_CTP00009.get(1).put("PWS_SAFE", "Softtek01");
			...
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00003_CTP00003.get(1).put("AUT_COORDENADOR", "51013346");				
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00003_CTP00003.get(1).put("AUT_PWD_COORDENADOR", "51013346");
			...
			sapDataRSP_PJTTRC_FRT001_SAP_MD00012_CN00003_CTP00005.get(1).put("AUT_DATA_INICIAL", "01.07.2019");	
			sapDataRSP_PJTTRC_FRT001_SAP_MD00012_CN00003_CTP00005.get(1).put("AUT_DATA_FINAL", "30.07.2019");			
			...
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00003_CTP00007.get(1).put("AUT_COORDENADOR", "51013346");
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00003_CTP00007.get(1).put("AUT_PWD_COORDENADOR", "51013346");
			...
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00003_CTP00007.get(1).put("AUT_NUMERO_DOCUMENTO", "18783107691863"); 			
			...
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00003_CTP00009.get(1).put("USER_SAFE", "51032900");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00003_CTP00009.get(1).put("PWS_SAFE", "Softtek01");
			...
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00004_CTP00003.get(1).put("AUT_PWD_COORDENADOR", "51013346");
			...
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00004_CTP00005.get(1).put("AUT_PWD_COORDENADOR", "51013346");	
			...
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00004_CTP00005.get(1).put("AUT_NUMERO_DOCUMENTO", "94288636370"); 			
			...
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00004_CTP00007.get(1).put("USER_SAFE", "51032900");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00004_CTP00007.get(1).put("PWS_SAFE", "Softtek01");
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00012_CN00005_CTP00001.get(1).put("AUT_NUMERO_DOCUMENTO", "22025");
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00012_CN00005_CTP00004.get(1).put("AUT_NUMERO_DOCUMENTO", "22025"); 
			...
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00005_CTP00005.get(1).put("AUT_NUMERO_DOCUMENTO", "22025"); 			
			...
			vaDataRSP_PJTTRC_FRT001_VA_MD00012_CN00005_CTP00006.get(1).put("AUT_NUMERO_DOCUMENTO", "22025"); 
			...
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00005_CTP00007.get(1).put("USER_SAFE", "51032900");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00005_CTP00007.get(1).put("PWS_SAFE", "Softtek01");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00005_CTP00007.get(1).put("AUT_NUMERO_DOCUMENTO", "22025"); 
			...
			//Inclusao de tabela - RSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001
			/**
			 * Parametros para configuração de componente de geração de voucher Pessoa Física 
			 * 
			 */
			...
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("USER_SAFE", "51032900");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("PWS_SAFE", "Softtek01");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_TIPO_PESSOA", AUT_SAFE_TYPE_PERSONS.FISICA );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_TIPO_CONVENIO", AUT_SAFE_TIPO_CONVENIO.CONSTRUTORA );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_PROFISSAO", AUT_SAFE_PROFISSOES.ARQUITETO );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_DOCUMENTO", "94288636370");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_PF_RG", "94288636370");			
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_ORG_EMISSOR", "SSP" ); 
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_DATA_NASCIMENTO","01/01/1985");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_NOME", "José da Silva" );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_EMAIL", "jsqa@automacaoo.com" );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_LOGRADOURO", "Rua Sem Nome");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_NUMERO_ENDERECO", "0");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_COMPLEMENTO_ENDERECO", "Fundos");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_BAIRRO", "Jaguare");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_CEP","05319-000");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_CIDADE","Sao Paulo");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_UF", "SP");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00011_CTP00001.get(1).put("AUT_TEL_DD1", "11");
			...
			//Inclusao de tabela - RSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001
			/**
			 * Parametros para configuração de componente de geração de voucher Pessoa Estrangeira
			 * ,
			 */
			...
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("USER_SAFE", "51032900");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("PWS_SAFE", "Softtek01");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("AUT_TIPO_PESSOA", AUT_SAFE_TYPE_PERSONS.ESTRANGEIRO );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("AUT_TIPO_CONVENIO", AUT_SAFE_TIPO_CONVENIO.CONSTRUTORA );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("AUT_PROFISSAO", AUT_SAFE_PROFISSOES.ENGENHEIRO );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("AUT_DOCUMENTO", "22025");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("AUT_PF_RG", "94288636370");			
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("AUT_DATA_NASCIMENTO","01/01/1985");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("AUT_NOME_ESTRANGEIRO", "Abin Salad" );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("AUT_EMAIL", "asqa@automacaoo.com" );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("AUT_LOGRADOURO", "Abu Dabi");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("AUT_NUMERO_ENDERECO", "0");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("AUT_COMPLEMENTO_ENDERECO", "15 Andar");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("AUT_BAIRRO", "Abu Salim");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("AUT_CEP","05319-000");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("AUT_CIDADE","Abu Dabi");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00012_CTP00001.get(1).put("AUT_UF", "Dabau");
			...
			//Inclusao de tabela - RSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001
			/**
			 * Parametros para configuração de componente de geração de voucher Pessoa Jurídica 
			 * 
			 */

			java.util.HashMap<Integer,java.util.HashMap<String,Object>> vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001 = new java.util.HashMap<Integer,java.util.HashMap<String,Object>>();	

			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.put(1, new java.util.HashMap<String,Object>());

			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("USER_SAFE", "51032900");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("PWS_SAFE", "Softtek01");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_TIPO_PESSOA", AUT_SAFE_TYPE_PERSONS.JURIDICA );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_TIPO_CONVENIO", AUT_SAFE_TIPO_CONVENIO.CONSTRUTORA );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_PROFISSAO", AUT_SAFE_PROFISSOES.DECORADOR );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_DOCUMENTO", "94288636370");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_ORG_EMISSOR", "SSP" ); 
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_DATA_NASCIMENTO","01/01/1985");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_NOME_PJ", "Delacroix Decoradora" );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_EMAIL", "dqa@automacao.com" );
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_LOGRADOURO", "Rue Saint Saens");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_NUMERO_ENDERECO", "1");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_COMPLEMENTO_ENDERECO", "");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_BAIRRO", "Champs Elisee");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_CEP","05319-000");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_CIDADE","Paris");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_UF", "Marselhe");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_TEL_DD1", "55");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_TEL_FONE1","19855555");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.get(1).put("AUT_TEL_RAMAL1","");
			
			
			AUT_GLOBAL_PARAMETERS.put(AUT_TABLE_PARAMETERS_NAMES.RSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001.toString(),vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00013_CTP00001);
