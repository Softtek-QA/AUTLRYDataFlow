...
//			vaDataRSP_PJTTRC_FRT001_VA_MD00012_CN00005_CTP00006.get(1).put("AUT_CODIGO_ITEM", "89296193"); 
			...
			/**
			 * Parametros para configuração de componente de Integração CAIXA_DINHEIRO_PF_COM_DEVOLUCAO Parte 1 - VA
			 * 
			 */
			...
			/**
			 * Parametros para configuração de componente de Integração CAIXA_DINHEIRO_PF_COM_DEVOLUCAO Parte 2 - PDV
			 * 
			 */
...
//			vaDataRSP_PJTTRC_FRT001_VA_MD00012_CN00007_CTP00004.get(1).put("AUT_CODIGO_ITEM", "89296193"); 
			...
			//Inclusao de tabela - RSP_PJTTRC_FRT001_PDV_MD00012_CN00007 CTP00005 e CTP00006
			/**
			 * Parametros para configuraÃ§Ã£o de componente de Integração CAIXA_DINHEIRO_PF_COM_DEVOLUCAO Parte 3 - PDV
			 * 
			 */		
...
//			vaDataRSP_PJTTRC_FRT001_VA_MD00012_CN00007_CTP00006.get(1).put("AUT_CODIGO_ITEM", "89296193"); 
			vaDataRSP_PJTTRC_FRT001_VA_MD00012_CN00007_CTP00006.get(1).put("AUT_NUMERO_DOCUMENTO", "94288636370"); //43409000283
			...
			//Inclusao de tabela - RSP_PJTTRC_FRT001_PDV_MD00012_CN00007 CTP00007
			/**
			 * Parametros para configuraÃ§Ã£o de componente de Integração CAIXA_DINHEIRO_PF_COM_DEVOLUCAO Parte 4 - SAFE
			 * 
			 */				
			...
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00007_CTP00007.get(1).put("USER_SAFE", "51028487");
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00007_CTP00007.get(1).put("PWS_SAFE", "Auto5@2017");
			...
			//pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00009_CTP00003.get(1).put("AUT_NUMERO_PEDIDO", "");				
			pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00009_CTP00003.get(1).put("AUT_COORDENADOR", "51028487");				
...
//			vaDataRSP_PJTTRC_FRT001_VA_MD00012_CN00009_CTP00004.get(1).put("AUT_CODIGO_ITEM", "89296193"); 
			...
			/**
			 * Parametros para configuraÃ§Ã£o de componente de Integração CAIXA_DINHEIRO_ESTRANGEIRA_COM_DEVOLUCAO Parte 3 - PDV
			 * 
			 */		
...
//			vaDataRSP_PJTTRC_FRT001_VA_MD00012_CN00009_CTP00006.get(1).put("AUT_CODIGO_ITEM", "89296193"); 
			vaDataRSP_PJTTRC_FRT001_VA_MD00012_CN00009_CTP00006.get(1).put("AUT_NUMERO_DOCUMENTO", "FR1234"); 
			...
			/**
			 * Parametros para configuraÃ§Ã£o de componente de Integração CAIXA_DINHEIRO_ESTRANGEIRA_COM_DEVOLUCAO Parte 4 - SAFE
			 * 
			 */				
			...
			vaDataRSP_PJTTRC_FRT001_SAFE_MD00012_CN00009_CTP00007.get(1).put("AUT_NUMERO_DOCUMENTO", "FR1234"); 
			...
			//pdvDataRSP_PJTTRC_FRT001_PDV_MD00012_CN00008_CTP00003.get(1).put("AUT_NUMERO_PEDIDO", "");				
...
//			vaDataRSP_PJTTRC_FRT001_VA_MD00012_CN00008_CTP00004.get(1).put("AUT_CODIGO_ITEM", "89296193"); 
			...
			//Inclusao de tabela - RSP_PJTTRC_FRT001_PDV_MD00012_CN00008 CTP00005 e CTP00006
			/**
			 * Parametros para configuraÃ§Ã£o de componente de Integração RETIR_INT_IMEDIATA_DINHEIRO_ESTRANGEIRA_COM_DEVOLUCAO Parte 3 - PDV
			 * 
			 */		
...
//			vaDataRSP_PJTTRC_FRT001_VA_MD00012_CN00008_CTP00006.get(1).put("AUT_CODIGO_ITEM", "89296193"); 
			...
			//Inclusao de tabela - RSP_PJTTRC_FRT001_PDV_MD00012_CN00008 CTP00007
			/**
			 * Parametros para configuraÃ§Ã£o de componente de Integração RETIR_EXT_IMEDIATA_DINHEIRO_ESTRANGEIRA_COM_DEVOLUCAO Parte 4 - SAFE
			 * 
			 */				
